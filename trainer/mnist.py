...
def train(log_dir='../logs',
    ...
    checkpoint_callback = keras.callbacks.ModelCheckpoint(filepath=checkpoint_location,
                                          monitor='val_acc',
                                          mode='max',
                                          verbose=1,
                                          save_best_only=True)
...
if __name__ == "__main__":
    # w_location = os.environ['WEIGHTS_LOCATION']
    ...
    # train(log_dir,checkpoint_location,w_location,json_location)